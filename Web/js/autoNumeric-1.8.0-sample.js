$(document).ready(function (e) {
    ...
    $("input.md").bind('click keyup blur', function () {
        var optionCode = '', aSepOption = '', dGroupOption = '', aDecOption = '', altDecOption = '', aSignOption = '', pSignOption = '', vMinOption = '', vMaxOption = '', mDecOption = '', mRoundOption = '', aPadOption = '', nBracketOption = '', wEmptyOption = '', lZeroOption = '', aFormOption = '';
        var dataCode = '', aSepData = '', dGroupData = '', aDecData = '', altDecData = '', aSignData = '', pSignData = '', vMinData = '', vMaxData = '', mDecData = '', mRoundData = '', aPadData = '', nBracketData = '', wEmptyData = '', lZeroData = '', aFormData = '';
